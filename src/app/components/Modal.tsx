                  ...
                  <div className="flex flex-col gap-y-0">
                    ...
                    <div className="flex border items-center border-slate-200 py-2 rounded-xl">
                      <input
                        name="fromForm"
                        type="number"
                        className="bg-transparent ml-3 font-raleway text-slate-900 font-regular !outline-none"
                        value={fromAmount}
                        onChange={(e) => {
                    ...
                    <p className="text-slate-700 text-sm mb-1 mt-4">
                      Our Match
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-4 w-full">
                      <button
                        className={`bg-red-500 hover:bg-red-400 text-white font-semibold w-full py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline ${
