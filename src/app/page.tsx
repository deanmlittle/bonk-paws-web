...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="shiba-2 mx-auto w-40 max-w-40 mt-12">
            ...
            <h1 className="text-4xl font-bold tracking-tighter text-yellow-950 sm:text-6xl mt-10">PAwesome Contributions</h1>
